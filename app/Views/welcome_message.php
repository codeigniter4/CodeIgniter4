    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-toggle"><a href="#" target="_self" onclick="toggleMenu();">&#9776;</a></li>
            </ul>
        </div>
