...
- Added Closure-based ``join()`` conditions for building ``JOIN ON`` clauses with protected column comparisons, bound values, and grouped conditions. See :ref:`query-builder-join-closure`.
