...
You can get the unique request ID for this request with the ``getRequestID()`` method.
This ID is generated by the framework and is unique to this request.
It can be used for logging or debugging purposes to track a specific request through the application.
...
.. code-block:: php
    ...
    // Returns the request ID, either from the header or generated by the framework
