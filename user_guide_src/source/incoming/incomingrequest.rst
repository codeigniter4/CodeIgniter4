...
.. php:class:: IncomingRequest
    ...
    .. php:method:: getRequestId()

        :returns: The unique request ID for this request, either from the ``X-Request-ID`` header or generated by the framework.
        :rtype: string

         The request ID is a 32-character hexadecimal string (or incoming header value if provided).
