...
The Database classes contain a few :doc:`Hooks </general/hooks>` that you can tap into in
...
This hook is triggered whenever a new query has been run, whether successful or not. The only parameter is
a :doc:`Query </database/query>` instance of the current query. You could use this to display all queries
