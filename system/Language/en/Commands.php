...
return [
    ...
    'generatorEmptyComponent'               => 'Generator component cannot be empty.',
    'generatorEmptyDirectory'               => 'Generator directory cannot be empty.',
    'generatorEmptyNamespace'               => 'Generator namespace cannot be empty.',
    'generatorEmptyTemplate'                => 'Generator template cannot be empty.',
    'generatorInvalidComponent'             => 'Generator component "{0}" is not valid.',
    'generatorInvalidDirectory'             => 'Generator directory "{0}" is not valid.',
    'generatorInvalidNamespace'             => 'Generator namespace "{0}" is not valid.',
