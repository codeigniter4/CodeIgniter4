...
class Security
{
	...
	public function CSRFVerify(RequestInterface $request)
	{
		...
		$CSRFTokenValue = $_POST[$this->CSRFTokenName] ??
			(! is_null($request->getHeaderObject($this->CSRFHeaderName)) && ! empty($request->getHeaderObject($this->CSRFHeaderName)->getValue()) ?
				$request->getHeaderObject($this->CSRFHeaderName)->getValue() :
