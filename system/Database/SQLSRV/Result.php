...
use const SQLSRV_SQLTYPE_BIGINT;
use const SQLSRV_SQLTYPE_BIT;
use const SQLSRV_SQLTYPE_CHAR;
use const SQLSRV_SQLTYPE_DATE;
use const SQLSRV_SQLTYPE_DATETIME;
use const SQLSRV_SQLTYPE_DATETIME2;
use const SQLSRV_SQLTYPE_DATETIMEOFFSET;
use const SQLSRV_SQLTYPE_DECIMAL;
use const SQLSRV_SQLTYPE_FLOAT;
use const SQLSRV_SQLTYPE_IMAGE;
use const SQLSRV_SQLTYPE_INT;
use const SQLSRV_SQLTYPE_MONEY;
use const SQLSRV_SQLTYPE_NCHAR;
use const SQLSRV_SQLTYPE_NTEXT;
use const SQLSRV_SQLTYPE_NUMERIC;
use const SQLSRV_SQLTYPE_NVARCHAR;
use const SQLSRV_SQLTYPE_REAL;
use const SQLSRV_SQLTYPE_SMALLDATETIME;
use const SQLSRV_SQLTYPE_SMALLINT;
use const SQLSRV_SQLTYPE_SMALLMONEY;
use const SQLSRV_SQLTYPE_TEXT;
use const SQLSRV_SQLTYPE_TIME;
use const SQLSRV_SQLTYPE_TIMESTAMP;
use const SQLSRV_SQLTYPE_TINYINT;
use const SQLSRV_SQLTYPE_UDT;
use const SQLSRV_SQLTYPE_UNIQUEIDENTIFIER;
use const SQLSRV_SQLTYPE_VARBINARY;
use const SQLSRV_SQLTYPE_VARCHAR;
use const SQLSRV_SQLTYPE_XML;
