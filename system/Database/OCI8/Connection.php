...
class Connection extends BaseConnection implements ConnectionInterface
{
    ...
    protected function _indexData(string $table): array
    {
        ...
        $sql = "SELECT AIC.INDEX_NAME, CASE WHEN AI.UNIQUENESS = 'UNIQUE' AND UC.CONSTRAINT_TYPE IS NULL THEN 'U' ELSE UC.CONSTRAINT_TYPE END CONSTRAINT_TYPE, AIC.COLUMN_NAME "
            ...
            . 'LEFT JOIN ALL_INDEXES AI ON AI.TABLE_OWNER = AIC.TABLE_OWNER AND UPPER(AI.TABLE_NAME) = '. $this->escape(strtoupper($table)) .' AND AI.OWNER = AIC.TABLE_OWNER AND AI.INDEX_NAME = AIC.INDEX_NAME '
            . 'WHERE UPPER(AIC.TABLE_NAME) = ' . $this->escape(strtoupper($table)) . ' '
            . 'AND UPPER(AIC.TABLE_OWNER) = ' . $this->escape(strtoupper($owner)) . ' '
