...
class Connection extends BaseConnection
{
    ...
    protected function _indexData(string $table): array
    {
        ...
        $sql = "SELECT name, CASE WHEN name LIKE 'sqlite_autoindex_%' THEN 'UNIQUE' ELSE '' END as indextype FROM sqlite_master WHERE type='index' AND tbl_name=" . $this->escape(strtolower($table)) . ' COLLATE NOCASE';
