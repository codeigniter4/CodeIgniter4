...
class Forge extends BaseForge
{
        ...
        foreach ($processedFields as $i => $field) {
            if ($field['_literal'] !== false) {
                ...
                if ($alterType === 'ADD') {
                    ...
                    $processedFields[$i]['_literal'] = (isset($field['new_name']) && $field['new_name'] !== '') ? "\n\tMODIFY " : "\n\tCHANGE ";
                }
    ...
    protected function _processColumn(array $processedField): string
    {
        ...
        return $this->db->escapeIdentifiers($processedField['name'])
                . (
                    (! isset($processedField['new_name']) && $processedField['new_name'] !== '')
                        ? ''
                ...
                . (
                    (! isset($processedField['comment']) && $processedField['comment'] !== '')
                        ? ''
