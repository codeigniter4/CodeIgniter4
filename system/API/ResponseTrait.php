...
trait ResponseTrait
{
	...
	/**
	 * Used when the data provided by the client cannot be validated on multiple fields.
	 *
	 * @param array       $errors
	 ...
	 * @return mixed
	 */
	public function failValidationErrors(array $errors, string $code = null, string $message = '')
	{
