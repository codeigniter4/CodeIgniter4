 ...
 *
 * @method false|int|string[]                 deleteBatch(array|object|null $set = null, array|RawSql|null $constraints = null, int $batchSize = 100)
 * @method $this                              distinct(bool $val = true)
 * @method bool                               emptyTable()
 * @method $this                              fromSubquery(BaseBuilder $from, string $alias)
 ...
 * @method $this                              ignore(bool $ignore = true)
 ...
 * @method $this                              onConstraint(array|RawSql|string $set = null)
 ...
 * @method $this                              setQueryAsData(BaseBuilder|RawSql $query, ?string $alias = null, array|string|null $columns = null)
 * @method bool                               truncate()
 * @method $this                              union(BaseBuilder|Closure $union)
 * @method $this                              unionAll(BaseBuilder|Closure $union)
 * @method BaseResult|false|int|object|string updateBatch(array|object|null $set = null, array|RawSql|string|null $constraints = null, int $batchSize = 100)
 * @method $this                              updateFields(string|string[] $set, bool $addToDefault = false, ?array $ignore = null)
 * @method BaseResult|false|int|object|string upsert(array|object|null $set = null, ?bool $escape = null)
