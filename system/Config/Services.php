...
class Services extends BaseService
{
    ...
    public static function email($config = null, bool $getShared = true)
    {
        ...
        if (((bool) $config === false) || ! (is_array($config) || $config instanceof EmailConfig)) {
    ...
    public static function language(?string $locale = null, bool $getShared = true)
    {
        ...
        $locale = ((bool) $locale !== false) ? $locale : $requestLocale;
    ...
    public static function parser(?string $viewPath = null, ?ViewConfig $config = null, bool $getShared = true)
    {
        ...
        $viewPath = ((bool) $viewPath !== false) ? $viewPath : (new Paths())->viewDirectory;
