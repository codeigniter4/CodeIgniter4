...
abstract class BaseHandler implements ImageHandlerInterface
{
	 ...
	 */
	public abstract function resize(int $width, int $height, bool $maintainRatio = false);
	 ...
	 * @return mixed
	 */
	public abstract function crop(int $width = null, int $height = null, int $x = null, int $y = null);
