...
class Session implements SessionInterface
{
     ...
     */
    public function __construct(SessionHandlerInterface $driver, AppConfig $config)
    {
        $this->driver = $driver;
        ...
        $this->ttl        = $session->ttl ?? $config->sessionTimeToUpdate ?? $this->ttl;
