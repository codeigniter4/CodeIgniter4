...
class CLIRequestTest extends \CIUnitTestCase
{
	...
	public function testParsingSegments() {
		$_SERVER['argv'] = ['index.php','users','21','profile','-foo','bar'];
		$_SERVER['argc'] = 6;

		// reinstantiate it to force parsing
		$this->request	 = new CLIRequest(new App());
		
		$segments = ['users','21','profile'];
	...
	public function testParsingOptionString() {
		$_SERVER['argv'] = ['index.php','users','21','profile','-foo','bar', '-baz', 'queue some stuff'];
		$_SERVER['argc'] = 8;
	...
	public function testParsingNoOptions() {
		$_SERVER['argv'] = ['index.php','users','21','profile'];
		$_SERVER['argc'] = 4;
	...
	public function testParsingMalformed() {
		$_SERVER['argv'] = ['index.php','users','21','pro-file','-foo','bar', '-baz', 'queue some stuff'];
		$_SERVER['argc'] = 8;
	...
	public function testParsingMalformed2() {
		$_SERVER['argv'] = ['index.php','users','21','profile','-foo','oops-bar', '-baz', 'queue some stuff'];
		$_SERVER['argc'] = 8;
