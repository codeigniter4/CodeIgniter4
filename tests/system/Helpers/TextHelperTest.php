...
class TextHelperTest extends CIUnitTestCase
{
	...
	{
		$this->assertEquals(16, mb_strlen(random_string('alnum', 16)));
		$this->assertEquals(16, mb_strlen(random_string('alpha', 16)));
		$this->assertEquals(16, mb_strlen(random_string('nozero', 16)));
		$this->assertEquals(16, mb_strlen(random_string('numeric', 16)));
		$this->assertEquals(8, mb_strlen(random_string('numeric')));

		$this->assertIsString(random_string('basic'));
		$this->assertEquals(16, mb_strlen($random = random_string('crypto', 16)));
		$this->assertIsString($random);

		$this->assertEquals(32, mb_strlen($random = random_string('md5')));
		$this->assertEquals(40, mb_strlen($random = random_string('sha1')));
	}
	...
	public function testWordWrap()
	{
		...
		$this->assertEquals(mb_substr_count(word_wrap($string, 25), "\n"), 3);
		$this->assertEquals($expected, word_wrap($string, 25));

		$string2   = "Here is a\nbroken up sentence\rspanning lines\r\nwoohoo!";
		$expected2 = "Here is a\nbroken up sentence\nspanning lines\nwoohoo!";
		$this->assertEquals(mb_substr_count(word_wrap($string2, 25), "\n"), 3);
		...
		$this->assertEquals(mb_substr_count(word_wrap($string3, 25), "\n"), 4);
	...
	public function testDefaultWordWrapCharlim()
	{
		...
		$this->assertEquals(mb_strpos(word_wrap($string), "\n"), 73);
	}
