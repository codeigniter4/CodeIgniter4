...
class FeatureResponseTest extends CIUnitTestCase
{
	...
	public function testGetJSON()
	{
		...
		$this->assertEquals(Services::format()->getFormatter('application/json')->format(['foo' => 'bar']), $this->feature->getJSON());
	}
	...
	public function testGetXML()
	{
		...
		$this->assertEquals(Services::format()->getFormatter('application/xml')->format(['foo' => 'bar']), $this->feature->getXML());
	}
	...
	public function testJsonExactString()
	{
		...
		$this->feature->assertJSONExact(Services::format()->getFormatter('application/json')->format($data));
	}
