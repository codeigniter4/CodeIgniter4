...
class AutoloadConfig
{
	...
	public function __construct()
	{
		...
		$this->classmap = [
			...
			'CodeIgniter\HTTP\MessageInterface'           => BASEPATH.'HTTP/MessageInterface.php',
			'CodeIgniter\HTTP\MessageTrait'               => BASEPATH.'HTTP/MessageTrait.php',
			'CodeIgniter\HTTP\Request'                    => BASEPATH.'HTTP/Request.php',
			'CodeIgniter\HTTPLite\Request'                => BASEPATH.'HTTPLite/Request.php',
			'CodeIgniter\HTTPLite\HTTPRequest'            => BASEPATH.'HTTPLite/HTTPRequest.php',
